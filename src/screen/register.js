...
import { TouchableOpacity, Text, View, Image, Alert,KeyboardAvoidingView } from "react-native";
...
export default function Register({ navigation }) {
  ...
  const SignUp = () => {
    return fetch('https://dienmayblue.site/PHP_Server/Signup.php', {
      ...
      .then((responseJson) => {
        ...
        Alert.alert(responseJson + "Đăng Ký Thành công");
  ...
  return (
    <KeyboardAvoidingView
      ...
      style={{flex:1}}
    >
    <View style={{ flex: 1, backgroundColor: "#fff6eb", paddingHorizontal: 12 }}>
